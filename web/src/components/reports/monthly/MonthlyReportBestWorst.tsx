...
export function MonthlyReportBestWorst({ state: s }: { state: State }) {
  return (
    <section className='space-y-4'>
      <h2 className='text-xl font-semibold'>Best / Worst Day</h2>

      <div className='grid grid-cols-1 gap-4 lg:grid-cols-2'>
        <div className='rounded-xl border border-[var(--table-divider)] bg-[var(--surface-elevated)] p-5'>
          ...
          <div className='mt-2 text-2xl font-bold tabular-nums text-[var(--profit)]'>
            {s.report.bestDay
