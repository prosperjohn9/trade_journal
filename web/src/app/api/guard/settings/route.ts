...
// POST /api/guard/settings  { connectionId, analyzedTf, executedTf, setupId }
//
// Save the per-account Foresight read context (analysis timeframe, execution
// timeframe, tagged setup). The always-on worker reads these so its auto-fired
// reads use the trader's real timeframes, not the day-trader default. Each value
// may be null/empty to clear it. RLS scopes the update to the owner.
